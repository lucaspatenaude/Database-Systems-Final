...
INSERT INTO Payments (payment_id, payment_status, payment_amount, payment_method) VALUES
    ...
    (19, 'Paid',     45.00, 'Card'),
    (20, 'Paid',     35.00, 'Card'),
    (21, 'Pending',  35.00, NULL),
    (22, 'Paid',     40.00, 'Card'),
    (23, 'Pending',  40.00, NULL),
    (24, 'Unpaid',   35.00, NULL),
    (25, 'Pending',  35.00, NULL),
    (26, 'Paid',     35.00, 'Card'),
    (27, 'Pending',  35.00, NULL),
    (28, 'Paid',     35.00, 'Card'),
    (29, 'Pending',  40.00, NULL),
    (30, 'Pending',  40.00, NULL),
    (31, 'Paid',     45.00, 'Card'),
    (32, 'Paid',     40.00, 'Card'),
    (33, 'Paid',     35.00, 'Card'),
    (34, 'Waived',    0.00, 'N/A'),
    (35, 'Pending',  35.00, NULL),
    (36, 'Paid',     35.00, 'Cash');
...
INSERT INTO Appointments (appointment_id, student_id, tutor_id, subject_id, appointment_date, appointment_time, session_length_mins, appointment_status, session_notes, room, follow_up_requested, payment_id) VALUES
    ...
    (19, 8,  5, 8, '2026-03-11', '17:00', 90, 'Completed',  'Forces and FBDs',                    'DUAN G1B20', TRUE,  19),
    (20, 9,  7, 9, '2026-03-12', '10:00', 60, 'Completed',  'Logic and proofs',                   'ECCR 1B40',  FALSE, 20),
    (21, 9,  2, 3, '2026-04-16', '10:30', 60, 'Scheduled',  NULL,                                 'Math 250',   FALSE, 21),
    (22, 10, 6, 5, '2026-03-13', '15:30', 60, 'Completed',  'ANOVA overview',                     'KOBL S240',  FALSE, 22),
    (23, 10, 3, 5, '2026-04-18', '15:30', 60, 'Scheduled',  NULL,                                 'Zoom',       FALSE, 23),
    (24, 11, 4, 6, '2026-03-14', '08:00', 60, 'No-Show',    NULL,                                 'CHEM 120',   FALSE, 24),
    (25, 11, 4, 6, '2026-04-19', '08:00', 60, 'Scheduled',  NULL,                                 'CHEM 120',   FALSE, 25),
    (26, 12, 7, 2, '2026-03-17', '18:00', 60, 'Completed',  'Trees and recursion',                'ECCR 1B40',  TRUE,  26),
    (27, 12, 7, 9, '2026-04-21', '18:00', 60, 'Scheduled',  NULL,                                 'ECCR 1B40',  TRUE,  27),
    (28, 3,  6, 5, '2026-03-18', '09:00', 60, 'Completed',  'Probability basics',                 'KOBL S240',  FALSE, 28),
    (29, 2,  2, 4, '2026-04-22', '11:00', 60, 'Scheduled',  NULL,                                 'Math 250',   FALSE, 29),
    (30, 6,  3, 5, '2026-04-23', '16:30', 60, 'Scheduled',  NULL,                                 'Zoom',       FALSE, 30),
    (31, 7,  4, 7, '2026-03-31', '12:00', 60, 'Completed',  'Nomenclature and reactions',         'CHEM 120',   TRUE,  31),
    (32, 10, 6, 5, '2026-03-25', '15:30', 60, 'Completed',  'Hypothesis testing',                 'KOBL S240',  FALSE, 32),
    (33, 5,  1, 1, '2026-03-21', '09:00', 60, 'Completed',  'Functions and arrays',               'ECCR 1B30',  FALSE, 33),
    (34, 9,  7, 9, '2026-03-26', '10:00', 60, 'Cancelled',  'Tutor unavailable',                  'ECCR 1B40',  FALSE, 34),
    (35, 8,  2, 3, '2026-04-24', '17:00', 60, 'Scheduled',  NULL,                                 'Math 250',   FALSE, 35),
    (36, 11, 6, 5, '2026-03-27', '08:00', 60, 'Completed',  'Exam review',                        'KOBL S240',  FALSE, 36);